    ...
    [6080], {
                ...
                constructor(e) {
                    ...
                    super(), this.accounts = [], this.handlers = {
                        ...
                        onAccountsUpdate: ({
                            ...
                            (0, d.areAddressArraysEqual)(this.accounts, e) || (this.accounts = e, "storage" !== t && this.emit("accountsChanged", this.accounts))
                        },
                        onChainUpdate: ({
                            chain: e,
                            source: t
                        }) => {
                            (e.id !== this.chain.id || e.rpcUrl !== this.chain.rpcUrl) && (this.chain = e, "storage" !== t && this.emit("chainChanged", (0, d.hexStringFromIntNumber)((0, c.IntNumber)(e.id))))
                        }
                    }, this.metadata = n, this.preference = p, this.communicator = new h.Communicator(o), this.chain = {
        ...
        46111: function(e, t, r) {
            ...
            class d {
                ...
                makeWeb3Provider(e = {
                    ...
                    return null !== (t = (0, c.getCoinbaseInjectedProvider)(r)) && void 0 !== t ? t : new n.CoinbaseWalletProvider(r)
                }
        ...
        47224: function(e, t, r) {
            ...
            t.serializeError = function(e, t) {
                ...
                return c && o.searchParams.set("method", c), o.searchParams.set("message", r.message), Object.assign(Object.assign({}, r), {
                    docUrl: o.href
                })
            }
        },
        86687: function(e, t, r) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            ...
            t.JSON_RPC_SERVER_ERROR_MESSAGE = "Unspecified server error.", t.getMessageFromCode = i, t.isValidCode = a, t.getErrorCode = function(e) {
                ...
                let r = {};
                return e && "object" == typeof e && !Array.isArray(e) && c(e, "code") && a(e.code) ? (r.code = e.code, e.message && "string" == typeof e.message ? (r.message = e.message, c(e, "data") && (r.data = e.data)) : (r.message = i(r.code), r.data = {
                    originalError: o(e)
                })) : (r.code = s.standardErrorCodes.rpc.internal, r.message = d(e, "message") ? e.message : n, r.data = {
                    originalError: o(e)
                }), t && (r.stack = d(e, "stack") ? e.stack : void 0), r
            }
        },
        17475: function(e, t) {
            "use strict";
        ...
        98997: function(e, t, r) {
            ...
            }, t.has0xPrefix = d, t.strip0x = l, t.prepend0x = u, t.isHexString = h, t.ensureHexString = p, t.ensureEvenLengthHexString = g, t.ensureAddressString = function(e) {
                if ("string" == typeof e) {
                    let t = l(e).toLowerCase();
        ...
        86080: function(e, t, r) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.CoinbaseWalletSDK = void 0;
            let s = r(46111);
            t.default = s.CoinbaseWalletSDK;
            var n = r(46111);
        ...
        5561: function(e, t, r) {
            ...
            class c {
                ...
                constructor(e) {
                    ...
                    let c = this.loadItemFromStorage(n),
        ...
        86510: function(e, t, r) {
            ...
            class f {
                constructor(e) {
                    ...
                    if (i) {
                        let e = i.split(" ");
                        "" !== e[0] && (this._addresses = e.map(e => (0, h.ensureAddressString)(e)), null === (t = this.updateListener) || void 0 === t || t.onAccountsUpdate({
                            accounts: this._addresses,
                            source: "storage"
                        }))
                    }
                    this._storage.getItem(g) && (null === (r = this.updateListener) || void 0 === r || r.onChainUpdate({
                        chain: {
                            id: this.getChainId(),
                ...
                updateProviderInfo(e, t) {
                    ...
                    this._storage.setItem(g, t.toString(10)), (0, h.ensureIntNumber)(t) === s && this.hasMadeFirstChainChangedEmission || (null === (r = this.updateListener) || void 0 === r || r.onChainUpdate({
                        chain: {
                            id: t,
                            rpcUrl: e
                        },
                ...
                async addEthereumChain(e, t, r, s, n, i) {
                    ...
                    let d = this.initializeRelay();
                    this._isAuthorized() || await d.requestEthereumAccounts();
                    let l = await d.addEthereumChain(e.toString(), t, n, r, s, i);
                    return !(0, c.isErrorResponse)(l) && ((null === (a = l.result) || void 0 === a ? void 0 : a.isApproved) === !0 && this.updateProviderInfo(t[0], e), (null === (o = l.result) || void 0 === o ? void 0 : o.isApproved) === !0)
                }
                async switchEthereumChain(e) {
                    ...
                    if ((0, c.isErrorResponse)(r)) {
                        ...
                        if (r.errorCode === u.standardErrorCodes.provider.unsupportedChain) throw u.standardErrors.provider.unsupportedChain();
                ...
                _setAddresses(e, t) {
                    ...
                    let s = e.map(e => (0, h.ensureAddressString)(e));
                ...
                _isKnownAddress(e) {
                    try {
                        ...
                        return this._addresses.map(e => (0, h.ensureAddressString)(e)).includes(t)
                    } catch (e) {}
                    return !1
                }
                ...
                _prepareTransactionParams(e) {
                    ...
                    return {
                        ...
                        gasPriceInWei: o,
                        maxFeePerGas: c,
                        maxPriorityFeePerGas: null != e.maxPriorityFeePerGas ? (0, h.ensureBigInt)(e.maxPriorityFeePerGas) : null,
                        gasLimit: null != e.gas ? (0, h.ensureBigInt)(e.gas) : null,
                        chainId: e.chainId ? (0, h.ensureIntNumber)(e.chainId) : this.getChainId()
                    }
                }
                _isAuthorized() {
                ...
                async _eth_requestAccounts() {
                    ...
                    try {
                        let t = this.initializeRelay();
                        if (e = await t.requestEthereumAccounts(), (0, c.isErrorResponse)(e)) throw Error(e.errorMessage)
                    } catch (e) {
                ...
                async _wallet_addEthereumChain(e) {
                    ...
                    if (!i.chainName || "" === i.chainName.trim()) throw u.standardErrors.rpc.invalidParams("chainName is a required field");
                    if (!i.nativeCurrency) throw u.standardErrors.rpc.invalidParams("nativeCurrency is a required field");
                    let a = parseInt(i.chainId, 16);
                    return await this.addEthereumChain(a, null !== (r = i.rpcUrls) && void 0 !== r ? r : [], null !== (s = i.blockExplorerUrls) && void 0 !== s ? s : [], i.chainName, null !== (n = i.iconUrls) && void 0 !== n ? n : [], i.nativeCurrency) ? {
                        jsonrpc: "2.0",
                        id: 0,
                        result: null
                    } : {
            ...
            class g {
                ...
                signEthereumTransaction(e) {
                    return this.sendRequest({
                        ...
                        params: {
                            ...
                            nonce: e.nonce,
                            gasPriceInWei: e.gasPriceInWei ? (0, h.bigIntStringFromBigInt)(e.gasPriceInWei) : null,
                            maxFeePerGas: e.gasPriceInWei ? (0, h.bigIntStringFromBigInt)(e.gasPriceInWei) : null,
                            maxPriorityFeePerGas: e.gasPriceInWei ? (0, h.bigIntStringFromBigInt)(e.gasPriceInWei) : null,
                            gasLimit: e.gasLimit ? (0, h.bigIntStringFromBigInt)(e.gasLimit) : null,
                            chainId: e.chainId,
                            shouldSubmit: !1
                        }
                    })
                ...
                signAndSubmitEthereumTransaction(e) {
                    return this.sendRequest({
                        ...
                        params: {
                            ...
                            nonce: e.nonce,
                            gasPriceInWei: e.gasPriceInWei ? (0, h.bigIntStringFromBigInt)(e.gasPriceInWei) : null,
                            maxFeePerGas: e.maxFeePerGas ? (0, h.bigIntStringFromBigInt)(e.maxFeePerGas) : null,
                            maxPriorityFeePerGas: e.maxPriorityFeePerGas ? (0, h.bigIntStringFromBigInt)(e.maxPriorityFeePerGas) : null,
                            gasLimit: e.gasLimit ? (0, h.bigIntStringFromBigInt)(e.gasLimit) : null,
                            chainId: e.chainId,
                            shouldSubmit: !0
                        }
                ...
                watchAsset(e, t, r, s, n, i) {
                    let a = {
                        ...
                        c = null,
                        d = (0, h.randomBytesHex)(8);
                    return c = this.ui.showConnecting({
                        isUnlinkedErrorState: this.isUnlinkedErrorState,
                        onCancel: e => {
                            this.publishWeb3RequestCanceledEvent(d), this.handleErrorResponse(d, a.method, e), null == c || c()
                        },
                        onResetConnection: this.resetAndReload
                    }), new Promise((e, t) => {
                        this.relayEventManager.callbacks.set(d, r => {
                            if (null == c || c(), (0, o.isErrorResponse)(r)) return t(Error(r.errorMessage));
                            e(r)
                ...
                switchEthereumChain(e, t) {
                    let r = {
                        ...
                        s = (0, h.randomBytesHex)(8);
                    return new Promise((e, t) => {
                        this.relayEventManager.callbacks.set(s, r => (0, o.isErrorResponse)(r) && r.errorCode ? t(u.standardErrors.provider.custom({
                            code: r.errorCode,
            ...
            class n {
                ...
                async encrypt(e) {
                    ...
                    let r = crypto.getRandomValues(new Uint8Array(12)),
                        ...
                        d = new Uint8Array(o),
                        l = new Uint8Array(c),
                        u = new Uint8Array([...r, ...d, ...l]);
                    return (0, s.uint8ArrayToHex)(u)
                }
                async decrypt(e) {
                    let t = this.secret;
                    if (64 !== t.length) throw Error("secret must be 256 bits");
                    return new Promise((r, n) => {
                        !async function() {
                            let i = await crypto.subtle.importKey("raw", (0, s.hexStringToUint8Array)(t), {
                                ...
                                o = a.slice(0, 12),
                                c = a.slice(12, 28),
                                d = new Uint8Array([...a.slice(28), ...c]),
                                l = {
                                    name: "AES-GCM",
                                    iv: new Uint8Array(o)
                                };
                            try {
                                let e = await window.crypto.subtle.decrypt(l, i, d),
                                    t = new TextDecoder;
                                r(t.decode(e))
                            } catch (e) {
                                n(e)
        ...
        32485: function(e, t, r) {
            ...
            class c {
                constructor({
                    ...
                    let d = new a.WalletLinkWebSocket(`${t}/rpc`, c);
                    d.setConnectionStateListener(async e => {
                        let t = !1;
                        switch (e) {
                    ...
                    }), this.ws = d, this.http = new i.WalletLinkHTTP(t, e.id, e.key)
                }
                connect() {
                ...
                async connect() {
                    ...
                    return new Promise((e, t) => {
                        ...
                        null === (s = this.connectionStateListener) || void 0 === s || s.call(this, r.CONNECTING), n.onclose = e => {
                            ...
                            var s;
                            e(), null === (s = this.connectionStateListener) || void 0 === s || s.call(this, r.CONNECTED), this.pendingData.length > 0 && ([...this.pendingData].forEach(e => this.sendData(e)), this.pendingData = [])
                        }, n.onmessage = e => {
                            var t, r;
            ...
            class c {
                ...
                static load(e) {
                    let t = e.getItem(i),
                        r = e.getItem(o),
                        s = e.getItem(a);
                    return t && s ? new c(e, t, s, "1" === r) : null
                }
                get id() {
                    return this._id
                }
        ...
        30054: function(e, t, r) {
            ...
            class l {
                ...
                render(e) {
                    this.root && ((0, i.render)(null, this.root), e && (0, i.render)((0, i.h)(u, Object.assign({}, e, {
                        onDismiss: () => {
                            this.clear()
                        },
        ...
        91989: function(e, t, r) {
            ...
            t.Snackbar = d, t.SnackbarContainer = e => (0, i.h)("div", {
                ...
                let [s, o] = (0, a.useState)(!0), [c, d] = (0, a.useState)(null != e && e);
                return (0, a.useEffect)(() => {
                    ...
                    class: (0, n.default)("-cbwsdk-snackbar-instance", s && "-cbwsdk-snackbar-instance-hidden", c && "-cbwsdk-snackbar-instance-expanded")
                }, (0, i.h)("div", {
        ...
        89665: function(e, t, r) {
            ...
            t.generateKeyPair = n, t.deriveSharedSecret = i, t.encrypt = a, t.decrypt = o, t.exportKeyToHexString = d, t.importKeyFromHexString = l, t.encryptContent = u, t.decryptContent = h
        },
        66320: function(e, t, r) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            ...
            t.fetchRPCRequest = i, t.getCoinbaseInjectedSigner = a, t.getCoinbaseInjectedProvider = function({
                ...
                if ("smartWalletOnly" !== t.options) {
                    ...
                    if (t) {
                        ...
                        return null === (r = t.setAppInfo) || void 0 === r || r.call(t, s, n, i), t
                    }
                }
                let s = function() {
                    var e, t;
        ...
        86105: function(e, t, r) {
            ...
            function l(e, t) {
                ...
                if ((p = e).lastIndexOf("]") === p.length - 1) {
                    ...
                    for (h in u = [], e = e.slice(0, e.lastIndexOf("[")), "string" == typeof t && (t = JSON.parse(t)), t) u.push(l(e, t[h]));
                    if ("dynamic" === r) {
                        var r, i, u, h, p, g = l("uint256", t.length);
                        u.unshift(g)
                    }
                    return s.concat(u)
                }
                if ("bytes" === e) return t = new s(t), u = s.concat([l("uint256", t.length), t]), t.length % 32 != 0 && (u = s.concat([u, n.zeros(32 - t.length % 32)])), u;
            ...
            e.exports = {
                rawEncode: function(e, t) {
                    ...
                    for (var o in e) {
                        var d = i(e[o]),
                            u = l(d, t[o]);
                        "string" === d || "bytes" === d || "dynamic" === c(d) ? (r.push(l("uint256", a)), n.push(u), a += u.length) : r.push(u)
                    }
                ...
                o = {
                    encodeData(e, t, r, a = !0) {
                        ...
                        if (a) {
                            ...
                            for (let s of r[e]) {
                                let [e, r] = d(s.name, s.type, t[s.name]);
                                o.push(e), c.push(r)
                            }
                        } else
                            for (let i of r[e]) {
                                ...
                                if (void 0 !== e) {
                                    ...
                                    else if ("string" === i.type) o.push("bytes32"), "string" == typeof e && (e = s.from(e, "utf8")), e = n.keccak(e), c.push(e);
                                    else if (void 0 !== r[i.type]) o.push("bytes32"), e = n.keccak(this.encodeData(i.type, e, r, a)), c.push(e);
        ...
        77114: function(e, t, r) {
            ...
            function o(e, t, r) {
                let s = i(t);
                return (e = c(e), r) ? e.length < t ? (e.copy(s), s) : e.slice(0, t) : e.length < t ? (e.copy(s, t - e.length), s) : e.slice(-t)
            }
            ...
            function c(e) {
                if (!s.isBuffer(e)) {
                    if (Array.isArray(e)) e = s.from(e);
                        ...
                        var t;
                        e = d(e) ? s.from((t = l(e)).length % 2 ? "0" + t : t, "hex") : s.from(e)
            ...
            e.exports = {
                ...
                twosFromBigInt: function(e, t) {
                    return (e < 0 n ? (~e & (1 n << BigInt(t)) - 1 n) + 1 n : e) & (1 n << BigInt(t)) - 1 n
                }
            }
        },
        54750: function(e, t) {
            ...
            function s() {
                for (var e, t, r = 0, s = ""; r < arguments.length;)(e = arguments[r++]) && (t = function e(t) {
                    ...
                    if ("string" == typeof t || "number" == typeof t) n += t;
                        ...
                        if (Array.isArray(t))
                            for (r = 0; r < t.length; r++) t[r] && (s = e(t[r])) && (n && (n += " "), n += s);
                        else
